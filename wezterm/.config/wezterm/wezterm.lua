...
config.ssh_domains = {
  {
    name = 'baobab',
    remote_address = 'login1.baobab.hpc.unige.ch',
    username = 'knafouj',
  },
  -- {
  --   name = 'text-analytics',
  --   remote_address = 'jknafou.lan.text-analytics.ch',
  --   username = 'jknafou',
  -- },
}
-- tmux
config.leader = { key = "F19", mods = "SHIFT", timeout_milliseconds = 2000 }
config.keys = {
    {
        key = "Backspace",
        mods = "CMD",
    ...
    },
    {
        mods = 'LEADER',
        key = 'b',
        action = wezterm.action.AttachDomain 'baobab',
    },
    {
        mods = 'LEADER',
        key = 'a',
        action = wezterm.action.AttachDomain 'text-analytics',
    },
    {
        mods = 'LEADER',
        key = 'd',
